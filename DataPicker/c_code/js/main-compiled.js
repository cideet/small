...
(function () {
    ...
    datapicker.buildUi = function (year, month) {
        ...
        var html = '<div class="ui-datapicker-header">' + '<a href="#" class="ui-datapicker-btn ui-datapicker-btn-prev">&lt;</a>' + '<span class="ui-datapicker-curr-month">' + monthData.year + '-' + monthData.month + '</span>' + '<a href="#" class="ui-datapicker-btn ui-datapicker-btn-next">&gt;</a>' + '</div>' + '<div class="ui-datapicker-body">' + '<table>' + '<thead>' + '<tr>' + '<th>日</th>' + '<th>一</th>' + '<th>二</th>' + '<th>三</th>' + '<th>四</th>' + '<th>五</th>' + '<th>六</th>' + '</tr>' + '</thead>' + '<tbody>';
